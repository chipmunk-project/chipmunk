...
#     counter_example_input = ""
#      for i in range(len(input_values)-1):
#        counter_example_input += input_values[i] + ", "
#      counter_example_input += hits[len(input_values)-1]
#     "assert pipeline(" + "x_" + str(round)  + ")" + " == " + "program(" + "x_" + str(round)  + ");\n"
