...
(let ((_n28 (+   _n1   _n27 ) ))
(let ((_n29 (=   _n28   _n0 ) ))
(implies  (and (and (>= state_group_0_state_0_5_5_0 0) (< state_group_0_state_0_5_5_0 32 ))  (and (and (>= pkt_1_4_4_0 0) (< pkt_1_4_4_0 32 ))  (and (>= pkt_0_3_3_0 0) (< pkt_0_3_3_0 32 )) ) )   (and  _n17  _n24  _n29 )  )))))))))))))))))))))))))))))))
(check-sat)
(get-model)
(exit)
