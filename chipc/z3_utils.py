...
def generate_counter_examples(smt2_filename):
    """Given a smt2 file that was generated by sketch, finds counterexample
    values for input packet and state group variables.

    Args:
        smt2_filename: smt2 file that was generated by Sketch.
    ...
    # we  simply take the Implies part, it will contain free variables intead
    # of named variables. We need to get the list of variables in the order
    # they appear in the Implies part and substitute them.
